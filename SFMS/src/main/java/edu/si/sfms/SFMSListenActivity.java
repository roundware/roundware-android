...
public class SFMSListenActivity extends Activity {
    ...
    private ServiceConnection rwConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if ((mWebView != null) && (mContentFileDir != null)) {
                String contentFileName = mRwBinder.getContentFilesDir() + "listen-a.html";
                try {
    ...
    private void initUIWidgets() {
        ...
        mHomeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent homeIntent = new Intent(SFMSListenActivity.this, SFMSMainActivity.class);
                SFMSListenActivity.this.startActivity(homeIntent);
            }
        });
        ...
        mRecordButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                stopPlayback();
                Intent intent = new Intent(SFMSListenActivity.this, SFMSSpeakActivity.class);
                SFMSListenActivity.this.startActivity(intent);
            }
        });
    }
