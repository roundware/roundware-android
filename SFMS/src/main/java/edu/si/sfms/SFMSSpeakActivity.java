...
import edu.si.sfms.utils.LevelMeterView;
import edu.si.sfms.utils.Utils;

public class SFMSSpeakActivity extends Activity {

    // intent actions to select recording type when starting the activity
    public final static String ACTION_RECORD_FEEDBACK = "edu.si.sfms.record_feedback";
    public final static String ACTION_RECORD_CONTRIBUTION = "edu.si.sfms.record_contribution";

    // settings for storing recording as file
    private final static String STORAGE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/edu_si_sfms/";
    ...
    private ServiceConnection rwConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            mTagsList.restoreSelectionState(getSharedPreferences(SFMSMainActivity.APP_SHARED_PREFS, MODE_PRIVATE));
    ...
    protected void onPause() {
        ...
        if (mTagsList != null) {
            mTagsList.saveSelectionState(getSharedPreferences(SFMSMainActivity.APP_SHARED_PREFS, MODE_PRIVATE));
        }
        super.onPause();
    }
    ...
    private void updateScreenForSelectedTags() {
        ...
        if (exhibits.getSelectedCount() == 1) {
            ...
            if (mViewFlipper != null) {
                ...
                int resId = getResources().getIdentifier(imageName, "drawable", "edu.si.sfms");
                if (resId != 0) {
    ...
    private class ConfirmDelete implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            alertBox = new AlertDialog.Builder(SFMSSpeakActivity.this);
